...
import com.example.selfeducate.databinding.FragmentAuthorizBinding

class AuthorizationFragment : Fragment(R.layout.fragment_authoriz) {

    private var binding1 : FragmentAuthorizBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding1 = FragmentAuthorizBinding.bind(view)
