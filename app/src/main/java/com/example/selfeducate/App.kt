...
import com.example.selfeducate.data.storage.AppDatabase
...
class App : Application() {
    ...
    override fun onCreate() {
        ...
        api = retrofit.create(ProjectApis::class.java)
    }
    ...
    companion object {
        ...
        const val BASE_URL = "https://c5db-212-42-120-155.in.ngrok.io"
